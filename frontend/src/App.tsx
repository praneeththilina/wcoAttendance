...
const ClientSelection = lazy(() =>
  import('@/pages/ClientSelection').then((m) => ({ default: m.ClientSelection }))
);
const CheckinConfirmation = lazy(() =>
  import('@/pages/CheckinConfirmation').then((m) => ({ default: m.CheckinConfirmation }))
);
const CheckOutScreen = lazy(() =>
  import('@/pages/CheckOutScreen').then((m) => ({ default: m.CheckOutScreen }))
);
const ChangeClientLocation = lazy(() =>
  import('@/pages/ChangeClientLocation').then((m) => ({ default: m.ChangeClientLocation }))
);
const AdminDashboard = lazy(() =>
  import('@/pages/AdminDashboard').then((m) => ({ default: m.AdminDashboard }))
);
const DailyAttendanceReport = lazy(() =>
  import('@/pages/DailyAttendanceReport').then((m) => ({ default: m.DailyAttendanceReport }))
);
const StaffDashboard = lazy(() =>
  import('@/pages/StaffDashboard').then((m) => ({ default: m.StaffDashboard }))
);
const AttendanceHistory = lazy(() =>
  import('@/pages/AttendanceHistory').then((m) => ({ default: m.AttendanceHistory }))
);
const Profile = lazy(() => import('@/pages/Profile').then((m) => ({ default: m.Profile })));
const AdminClients = lazy(() =>
  import('@/pages/AdminClients').then((m) => ({ default: m.AdminClients }))
);
const AdminLeaves = lazy(() =>
  import('@/pages/AdminLeaves').then((m) => ({ default: m.AdminLeaves }))
);
...
const HRDashboard = lazy(() =>
  import('@/pages/HRDashboard').then((m) => ({ default: m.HRDashboard }))
);
