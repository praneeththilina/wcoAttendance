              ...
              <form onSubmit={handleRequestSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="col-span-2">
                    <label htmlFor="leaveType" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">
                      Leave Type
                    </label>
                    <select
                      id="leaveType"
                  ...
                  <div>
                    <label htmlFor="startDate" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">
                      Start Date
                    </label>
                    <input
                      id="startDate"
                  ...
                  <div>
                    <label htmlFor="endDate" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">
                      End Date
                    </label>
                    <input
                      id="endDate"
                  ...
                  <div>
                    <label htmlFor="totalDays" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">
                      Total Days
                    </label>
                    <input
                      id="totalDays"
