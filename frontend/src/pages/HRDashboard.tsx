...
<input className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-lg py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary/20" placeholder="Search employees, records, or files..." type="text"/>
</div>
...
<p className="text-slate-500 mt-1">Welcome back, Admin. Here is what's happening across the firm today.</p>
</div>
{/* Stats Cards */}
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
<div className="flex items-center justify-between mb-4">
<span className="p-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 rounded-lg material-symbols-outlined">person</span>
<span className="text-xs font-bold text-green-600 bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded-full">+2.4%</span>
</div>
<p className="text-sm font-medium text-slate-500">Total Employees</p>
<p className="text-3xl font-bold mt-1">{isLoading ? "-" : stats?.totalEmployees || 0}</p>
</div>
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
<div className="flex items-center justify-between mb-4">
<span className="p-2 bg-orange-50 dark:bg-orange-900/30 text-orange-600 rounded-lg material-symbols-outlined">event_available</span>
<span className="text-xs font-bold text-green-600 bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded-full">+5.1%</span>
</div>
...
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
<div className="flex items-center justify-between mb-4">
<span className="p-2 bg-purple-50 dark:bg-purple-900/30 text-purple-600 rounded-lg material-symbols-outlined">verified</span>
<span className="text-xs font-bold text-blue-600 bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded-full">Stable</span>
</div>
...
<span className="text-sm font-semibold text-slate-700 dark:text-slate-200">Export Payroll Data</span>
</div>
...
<span className="text-sm font-semibold text-slate-700 dark:text-slate-200">Audit Trail Logs</span>
</div>
<span className="material-symbols-outlined text-slate-400 group-hover:translate-x-1 transition-transform">chevron_right</span>
</button>
<button className="w-full flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 transition-colors group">
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-slate-500">holiday_village</span>
<span className="text-sm font-semibold text-slate-700 dark:text-slate-200">Manage Leaves</span>
</div>
<span className="material-symbols-outlined text-slate-400 group-hover:translate-x-1 transition-transform">chevron_right</span>
</button>
</div>
...
<p className="text-blue-100 text-sm mb-4">You have 12 interviews scheduled for this week. Keep up the pace!</p>
<button className="bg-white text-primary px-4 py-2 rounded-lg text-xs font-bold shadow-sm">Review Calendar</button>
</div>
<span className="material-symbols-outlined absolute -right-4 -bottom-4 text-9xl text-white/10 select-none pointer-events-none">groups</span>
</div>
</div>
</div>
</div>
