      ...
      <main className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-900/50">
        ...
        <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button aria-label="Notifications" className="relative p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg">
              <span className="material-symbols-outlined">notifications</span>
              <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full border-2 border-white dark:border-slate-900"></span>
            </button>
            <button aria-label="Help" className="p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg">
                      ...
                      stats.todaysAttendance.map((record) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button aria-label="More options" className="text-primary hover:text-primary/80 transition-colors">
