...
## 2026-04-07 - Icon Button Accessibility
**Learning:** Standard Tailwind resets remove inherent visual cues from icon-only buttons, making explicit ARIA labels and focus states necessary.
**Action:** Always add aria-labels and focus-visible rings to interactive icon elements.
