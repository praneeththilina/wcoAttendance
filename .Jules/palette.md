...
## 2026-04-23 - Focus Rings for Icon Buttons
**Learning:** In Tailwind CSS based design systems, default icon-only buttons often lack visual focus indicators, making keyboard navigation difficult to track.
**Action:** Always add standard focus rings (e.g., `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary`) to interactive elements, particularly icon-only buttons like 'Go back'.
