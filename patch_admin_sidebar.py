...
sidebar_component = """import { NavLink } from 'react-router-dom';
...
with open('frontend/src/components/layout/AdminSidebar.tsx', 'w') as f:
    f.write(sidebar_component)

with open('frontend/src/components/layout/index.ts', 'r') as f:
    index_content = f.read()

if 'AdminSidebar' not in index_content:
    with open('frontend/src/components/layout/index.ts', 'a') as f:
        f.write("\nexport { AdminSidebar } from './AdminSidebar';\n")

# Now update the AdminBottomNav to be hidden on md screens
with open('frontend/src/components/layout/AdminBottomNav.tsx', 'r') as f:
    bottom_nav = f.read()

bottom_nav = bottom_nav.replace('className="fixed bottom-0', 'className="md:hidden fixed bottom-0')
with open('frontend/src/components/layout/AdminBottomNav.tsx', 'w') as f:
    f.write(bottom_nav)

print("Created AdminSidebar and updated AdminBottomNav")
